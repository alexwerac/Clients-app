...
const clientPromise = MongoClient.connect(process.env.DB_URL || 'mongodb+srv://alexwerac:A92239223a@cluster0.kcnp6.mongodb.net/Clients_db?retryWrites=true&w=majority', {
